...
<template>
    <div class="h-14 bg-light-blue border border-t-2 border-t-background flex">
        <button @click.prevent="$emit('back')" class="w-14  rotate-180  flex items-center justify-center">
