...
<template>
    <div class="flex flex-col h-full mx-8">
        <p class="text-light-blue text-5xl font-extrabold text-center mt-6">Hallo!</p>
        <p class="text-light-blue text-2xl font-semibold text-center mt-6">Schön, dass deine Miete Dich nicht kalt lässt.<br>
