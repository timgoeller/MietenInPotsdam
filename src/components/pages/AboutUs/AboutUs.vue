...
<template>
    <div class="flex justify-center flex-col items-center w-full text-light-blue my-6 px-8">
        <div class="max-w-3xl flex flex-col items-center relative gap-4">
            ...
            <h2 class="text-3xl  font-semibold">Über uns</h2>
            <div class="flex flex-col h-full gap-4 text-justify">
                <p>Wir - Malina, Lou, Tim & Fritzi - sind Studierende des Masters <i>Urbane Zukunft</i> an der Fachhochschule Potsdam. Im Rahmen unseres Semesterprojekts beschäftigen wir uns intensiv mit dem Potsdamer Mietmarkt und den individuellen Mietsituationen der Potsdamer:innen.</p>
